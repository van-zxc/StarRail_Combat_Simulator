"""Himeko Eidolons — 星魂 1-6。

来源: 1003_himeko.json eidolons
"""
...
def eidolon_3(owner) -> list:
    ...
    if skill:
        skill.skill_multiplier += 0.20
        skill.skill_adjacent += 0.08
...
def eidolon_5(owner) -> list:
    ...
    if ult:
        ult.skill_multiplier += 0.184
    talent = owner._skills.get("talent")
    if talent:
        talent.skill_multiplier += 0.14
    return []
