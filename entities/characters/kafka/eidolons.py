...
"""Kafka Eidolons — 星魂 1-6 (Enhanced)。

来源: 1005_kafka.json eidolons
"""
...
def eidolon_3(owner) -> list:
    ...
    if skill:
        skill.skill_multiplier += 0.16
        skill.skill_adjacent += 0.06
...
def eidolon_5(owner) -> list:
    ...
    if ult:
        ult.skill_multiplier += 0.064
    talent = owner._skills.get("talent")
    if talent:
        talent.skill_multiplier += 0.196
    return []
