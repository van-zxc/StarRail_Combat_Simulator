...
特效: 战斗开始时，使装备者的效果命中提高#1[i]%，持续#2[i]回合。
"""
...
class DeepDark(BaseLightCone):
    ...
    def __init__(self, id: str = "", **kwargs):
        ...
        if self.effect is None:
            self.effect = DeepDarkEffect(self.superimpose)


class DeepDarkEffect(EquipmentEffect):
    _PARAMS = [
        [0.20, 3],
        [0.25, 3],
        [0.30, 3],
